...
import com.example.webrtccalling.databinding.ActivityCallBinding
import com.example.webrtccalling.service.MainService
import com.example.webrtccalling.service.MainServiceRepository
import com.example.webrtccalling.utils.convertToHumanTime
...
class CallActivity : AppCompatActivity(), MainService.EndCallListener {
    ...
    private fun init(){
        ...
        views.apply {
            getUserName(target!!) { sendername ->
                callTitleTv.text = "In call with $sendername"
            }
    ...
    override fun onCallEnded() {
        startActivity(Intent(applicationContext, MainActivity::class.java))    // chnages made for handling on end call
        finish()
    }
